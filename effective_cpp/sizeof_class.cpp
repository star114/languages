 ...
 * =====================================================================================
 *
 *       Filename:  sizeof_class.cpp
 *
 *    Description:  class size 
 *
 *        Version:  1.0
 *        Created:  07/24/15 11:20:34
 *       Revision:  none
 *       Compiler:  gcc
 *
...
int main()
{
  ...
  cout <<"sizeof(class I) after making foo static and virtual : " << sizeof(I) << endl ;
  I i;
  I i2;
  
  cout <<"sizeof(instance i) " << sizeof(i) << endl ;
  cout << &i << endl;
  cout << &i2 << endl;
  cout <<"sizeof(class J) static  " << sizeof(J) << endl ;
  
  J j;
  cout <<"sizeof(instance j) " << sizeof(j) << endl ;
